...
//        fadeTransition.play();
        ...
        pane1.setStyle("-fx-background-image: url('ejemplo/1.jpg')");
        pane2.setStyle("-fx-background-image: url('ejemplo/2.jpg')");
        pane3.setStyle("-fx-background-image: url('ejemplo/3.jpg')");
        pane4.setStyle("-fx-background-image: url('ejemplo/4.jpg')");
